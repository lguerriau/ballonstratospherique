...
${OBJECTDIR}/RadioLib/src/Hal.o: RadioLib/src/Hal.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DRADIOLIB_PLATFORM_PIHAL -IRadioLib/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RadioLib/src/Hal.o RadioLib/src/Hal.cpp

${OBJECTDIR}/RadioLib/src/Module.o: RadioLib/src/Module.cpp
	${MKDIR} -p ${OBJECTDIR}/RadioLib/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -DRADIOLIB_PLATFORM_PIHAL -IRadioLib/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RadioLib/src/Module.o RadioLib/src/Module.cpp
...
${OBJECTDIR}/RadioLib/src/modules/SX127x/SX1278.o: RadioLib/src/modules/SX127x/SX1278.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DRADIOLIB_PLATFORM_PIHAL -IRadioLib/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RadioLib/src/modules/SX127x/SX1278.o RadioLib/src/modules/SX127x/SX1278.cpp

${OBJECTDIR}/RadioLib/src/modules/SX127x/SX127x.o: RadioLib/src/modules/SX127x/SX127x.cpp
	${MKDIR} -p ${OBJECTDIR}/RadioLib/src/modules/SX127x
	${RM} "$@.d"
	$(COMPILE.cc) -g -DRADIOLIB_PLATFORM_PIHAL -IRadioLib/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RadioLib/src/modules/SX127x/SX127x.o RadioLib/src/modules/SX127x/SX127x.cpp
...
${OBJECTDIR}/RadioLib/src/protocols/PhysicalLayer/PhysicalLayer.o: RadioLib/src/protocols/PhysicalLayer/PhysicalLayer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DRADIOLIB_PLATFORM_PIHAL -IRadioLib/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RadioLib/src/protocols/PhysicalLayer/PhysicalLayer.o RadioLib/src/protocols/PhysicalLayer/PhysicalLayer.cpp

${OBJECTDIR}/RadioLib/src/utils/Utils.o: RadioLib/src/utils/Utils.cpp
	${MKDIR} -p ${OBJECTDIR}/RadioLib/src/utils
	${RM} "$@.d"
	$(COMPILE.cc) -g -DRADIOLIB_PLATFORM_PIHAL -IRadioLib/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RadioLib/src/utils/Utils.o RadioLib/src/utils/Utils.cpp

${OBJECTDIR}/bme280.o: bme280.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DRADIOLIB_PLATFORM_PIHAL -IRadioLib/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bme280.o bme280.cpp

${OBJECTDIR}/i2c.o: i2c.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DRADIOLIB_PLATFORM_PIHAL -IRadioLib/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/i2c.o i2c.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DRADIOLIB_PLATFORM_PIHAL -IRadioLib/src -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
