...
/**
 * @brief  Méthode pour obtenir la température.
 * @details Lit le registre de température sur 16 bits puis convertit la valeur brute 
 * signée en une valeur réelle exploitable.
