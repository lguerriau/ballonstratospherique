...
${OBJECTDIR}/_ext/7a03ee3f/bme280.o: ../BME280/bme280.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/7a03ee3f/bme280.o ../BME280/bme280.cpp
...
${OBJECTDIR}/AprsBuilder.o: AprsBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AprsBuilder.o AprsBuilder.cpp

${OBJECTDIR}/RadioManager.o: RadioManager.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RadioManager.o RadioManager.cpp

${OBJECTDIR}/StationApp.o: StationApp.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StationApp.o StationApp.cpp
...
${OBJECTDIR}/sx1278-LoRa-RaspberryPi-master/LoRa.o: sx1278-LoRa-RaspberryPi-master/LoRa.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sx1278-LoRa-RaspberryPi-master/LoRa.o sx1278-LoRa-RaspberryPi-master/LoRa.c
