...
// 1. On crée les objets du collègue
Modele maBdd;
Log monLog;

// 2. On crée TON objet, en lui branchant les outils du collègue
GestionLoRa monLoRa(&maBdd, &monLog);
    ...
    void setup() { 
        ...
        monLoRa.begin(); 
        Serial.println("[OK] Écoute en cours...\n");
    }
